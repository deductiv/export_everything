...
class ConfigApp(admin.MConfigHandler):
	...
	def handleList(self, confInfo):
		...
		logger.debug("HEC config list handler started")
	...
	def handleEdit(self, confInfo):
		logger = setup_logger('INFO', 'hep_setup.log')
		logger.debug("HEC config edit handler started")
		...
		try:
			...
			self.writeConf('hep', 'hec', new_config)
		except BaseException as e:
			logger.critical("Error writing HEC config: " + repr(e))
			exit(1)
